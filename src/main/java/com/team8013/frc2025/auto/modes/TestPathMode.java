...
// trajectory1 = AutoTrajectoryReader.generateTrajectoryFromFile(path1,
// Constants.AutoConstants.createConfig(4.8, 1.8, 0.0, 0.0));
// driveAction1 = new SwerveTrajectoryAction(trajectory1,
...
// Constants.AutoConstants.createConfig(4.8, 1.8, 0.0, 0.0));
// driveAction2 = new SwerveTrajectoryAction(trajectory2,
// Rotation2d.fromDegrees(0.0));
// ShuffleBoardInteractions.getInstance().mFieldView.addTrajectory("Traj2",
// trajectory2);
...
// // }
// return new Pose2d(trajectory1.getInitialPose().getTranslation(),
// startingRotation);
// }
// }
